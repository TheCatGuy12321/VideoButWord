# FULL CREDIT TO: https://github.com/c0decracker/video-splitter/tree/master
# I DID NOT MAKE THIS
# Usage:
# python ffmpeg-split.py -f <file>.mp4 -s 10 -o <output folder>
# SPECIFY THE INPUTS/ DIRECTORY!!
